...
\usepackage[bookmarks, colorlinks, breaklinks, pdftitle={Jan Heiland - List of Publications},pdfauthor={Jan Heiland}]{hyperref} % PDF setup - set your name and the title of the document to be incorporated into the final PDF file meta-information
...
% The articles in \textbf{boldface} are those that I want to submit to your particular consideration.
...
\input{chap-publications-selected}
